    ...
    return (
        ...
        >
            <div className="text-center" id={'citas'}>
                ...
                <p className="text-tartiary md:w-1/3 mx-auto px-4">Consultas terapéuticas activas/proximas. Las consultas ya concluidas se ven en el historial de consultas en información del usuario.</p>
            </div>
